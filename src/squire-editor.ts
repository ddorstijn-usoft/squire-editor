  ...
  [
    ...
    },
    {
      ...
      handler(squire, _, event) {
        ...
        const editor = target.querySelector('.squire-input')! as HTMLDivElement;
        const buttons = target.querySelectorAll('.squire-toolbar button')! as NodeListOf<HTMLButtonElement>;
